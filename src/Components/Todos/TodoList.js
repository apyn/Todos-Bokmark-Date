    ...
    <div className="bg-white dark:bg-slate-700 rounded-2xl shadow-xl flex flex-col justify-center overflow-hidden ">
      ...
      <div className="flex justify-between items-center  p-4 border-b-2 dark:text-zinc-300 border-indigo-900 dark:border-zinc-300 mt-1">
        ...
        <div
          ...
          className=" cursor-pointer flex items-center justify-between dark:bg-slate-800 dark:text-zinc-300 bg-indigo-900 text-white font-bold text-xs rounded-lg px-2 py-2"
        >
      ...
      <div
        className={
          hide
            ? 'blur-sm text-gray-500 dark:text-zinc-200 h-96 p-4 overflow-y-auto'
            : 'text-gray-500 dark:text-zinc-200 h-96 p-4 overflow-y-auto '
        }
      >
        {todo.map((t) => {
          return (
            <div className="flex items-center justify-between py-1  hover:bg-gray-100 dark:hover:bg-zinc-400 border-b-2">
              <div className="flex justify-between items-center gap-x-1  ">
                ...
                <input
                  ...
                  className={
                    t.iscompleted
                      ? 'form-checkbo text-indigo-800 dark:text-slate-900 outline-none focus:ring-0 rounded'
                      : 'form-checkbox ml-1 rounded'
                  }
                ...
                <span
                  className={
                    t.iscompleted
                      ...
                      : 'text-sm dark:text-zinc-300  text-slate-700 font-bold'
                  }
                >
                  {' '}
                  {t.text}{' '}
